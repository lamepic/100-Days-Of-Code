...
export default function Home() {
  return (
    <>
      <div className="h-[95vh] bg-[#404eed] relative z-10">
        <div>
          <div className="flex justify-between items-center py-5 w-[90%] mx-auto">
            ...
            <div className="lg:flex justify-between text-white w-[40%] font-semibold items-center hidden">
            ...
            <div className="flex items-center justify-between">
              <Link href="/login">
                <a className="w-16 h-10 rounded-full bg-white text-sm mr-5 flex items-center justify-center">
                  Login
                </a>
              </Link>
              <span className="text-white font-semibold hover:cursor-pointer lg:hidden text-xl">
                <svg
        ...
        <div className="relative h-[88%] overflow-hidden">
          <div className="text-white w-[60%] mx-auto mt-32 text-center">
            ...
            <div className="flex justify-center items-center mt-8">
              <button className="flex justify-between items-center py-3 px-5 bg-white text-black rounded-full text-lg mr-6">
                <span className="mr-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
              ...
              <button className="flex justify-between items-center py-3 px-6 bg-[#202225] text-white rounded-full text-lg">
      ...
      <Section
        bg="bg-[#fffff]"
        img="/assets/invite_only_landing.svg"
      ...
      <Section
        ...
        img="/assets/hanging_out_easy_landing.svg"
        title="Where hanging out is easy"
        subtitle="Grab a seat in a voice channel when you’re free. Friends in your server can see you’re around and instantly pop in to talk without having to call."
      />
      <Section
        bg="bg-[#fffff]"
        img="/assets/fandom_landing.svg"
        title="From few to a fandom"
        subtitle="Get any community running with moderation tools and custom member access. Give members special powers, set up private channels, and more."
      />
      <div className="bg-[#f6f6f6] flex flex-col items-center">
        <div className=" w-[70%] mx-auto">
          <h1 className="mt-36 text-6xl text-center uppercase">
        ...
        <div className="flex flex-col items-center relative">
          ...
          <button className="flex items-center bg-[#5865F2] px-8 py-4 mt-12 rounded-full text-white capitalize text-lg">
            <span className="mr-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
        ...
        <div className="mt-28 bg-[#23272A] w-full text-white px-16 pt-20 pb-16 divide-y-2 divide-[#5865F2]">
          <div className="flex pb-10">
            <div className="flex-[0.2] ">
              <h1 className="text-4xl text-[#5865F2] uppercase">
                Imagine a place
              </h1>
              <div className="flex mt-5 justify-between w-[60%] items-center">
                <Image src="/assets/usa_flag.png" height={18} width={25} />
                <p>English, USA</p>
                <span>
                  {" "}
                  <svg
            ...
            <div className="flex-[0.8] flex justify-around">
              <div>
                <h2 className="text-[#4C64D8]">Product</h2>
              ...
              <div>
                <h2 className="text-[#4C64D8]">Company</h2>
                <div className="flex flex-col gap-2 mt-1">
              ...
              <div>
                <h2 className="text-[#4C64D8]">Resources</h2>
                <div className="flex flex-col gap-2 mt-1">
              ...
              <div>
                <h2 className="text-[#4C64D8]">Policies</h2>
                <div className="flex flex-col gap-2 mt-1">
          ...
          <div className="pt-10">
            <div className="flex justify-between items-center">
              ...
              <Link href="/signup">
                <a className="w-20 h-10 rounded-full bg-[#5865F2] text-sm flex items-center justify-center">
                  Sign up
                </a>
              </Link>
            </div>
